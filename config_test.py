...
def parse_args():
    ...
    # in/out
    parser.add_argument('--outf', default='/home/pixel/cly/remote_workspace/vessel2/experiments',
                        help='trained model will be saved at here')

    # parser.add_argument('--save', default='UNet_DConv', help='save name of experiment in args.outf directory')
    ...
    # parser.add_argument('--save', default='My_net_ODConv_stare', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='AttUNet', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='DenseUNet', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='R2UNet', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='FRUNet', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='PSPNet', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='SegNet', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='SAUNet_chase', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='ladderNet', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='UNet', help='save name of experiment in args.outf directory')
    ...
    parser.add_argument('--train_data_path_list',
                        default='/home/pixel/cly/remote_workspace/vessel2/prepare_dataset/data_path_list/DRIVE/train.txt')
    parser.add_argument('--test_data_path_list',
                        default='/home/pixel/cly/remote_workspace/vessel2/prepare_dataset/data_path_list/DRIVE/test.txt')

    # # data   STARE
    # parser.add_argument('--train_data_path_list',
    #                     default='/home/pixel/cly/remote_workspace/vessel2/prepare_dataset/data_path_list/STARE/train.txt')
    # parser.add_argument('--test_data_path_list',
    #                     default='/home/pixel/cly/remote_workspace/vessel2/prepare_dataset/data_path_list/STARE/test.txt')

    # # data   CHASEDB1
    # parser.add_argument('--train_data_path_list',
    #                     default='/home/pixel/cly/remote_workspace/vessel2/prepare_dataset/data_path_list/CHASEDB1/train.txt')
    # parser.add_argument('--test_data_path_list',
    #                     default='/home/pixel/cly/remote_workspace/vessel2/prepare_dataset/data_path_list/CHASEDB1/test.txt')
