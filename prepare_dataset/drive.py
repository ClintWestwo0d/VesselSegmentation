...
if __name__ == "__main__":
    #------------Path of the dataset -------------------------
    data_root_path = '/home/pixel/cly/remote_workspace/vessel2/datasets'
    ...
    # # ------------Path of the dataset -------------------------
    # data_root_path = 'C:\\Users\\97860\\exp\\OCE-Net\datasets'
    # # train
    # img_train = "DRIVE\\training\\images\\"
    # gt_train = "DRIVE\\training\\1st_manual\\"
    # fov_train = "DRIVE\\training\\mask\\"
    # # test
    # img_test = "DRIVE\\test\\images\\"
    # gt_test = "DRIVE\\test\\1st_manual\\"
    # fov_test = "DRIVE\\test\\mask\\"
    # # ----------------------------------------------------------
    # save_path = ".\\data_path_list\\DRIVE\\"
