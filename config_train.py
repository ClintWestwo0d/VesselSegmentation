...
def parse_args():
    ...
    # parser.add_argument('--save', default='CCNet', help='save name of experiment in args.outf directory')
    # parser.add_argument('--save', default='My_net_ODConv_chase', help='save name of experiment in args.outf directory')
    ...
    # parser.add_argument('--train_data_path_list',
    #                     default='C:\\Users\\97860\\exp\\OCE-Net\\prepare_dataset\\data_path_list\\DRIVE\\train.txt')
    # parser.add_argument('--test_data_path_list',
    #                     default='C:\\Users\\97860\\exp\\OCE-Net\\prepare_dataset\\data_path_list\\DRIVE\\test.txt')
