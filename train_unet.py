...
def main():
    ...
    # net = models.get_fcn32s(2).to(device)
    ...
    # net = models.resunet.ResUNet(1,2).to(device)
    # net = models.FR_UNet(2,1).to(device)
    # net = models.res.ResUNet(1,2).to(device)
    # net = models.Iternet(1,2).to(device)
    # net = models.SA_UNet(1,2).to(device)
    # net = models.ResUNet(1,2).cuda()
    ...
    # net = models.UNetFamily.NestedUNet(1,2).to(device)
    # net = models.UNetFamily.UNetpp(1, 2).to(device)
    # net = models.UNetFamily.UNet2Plus(1, 2).to(device)
    ...
    # net = models.OCE_Net.OCENet_mine(1, 2).to(device)
